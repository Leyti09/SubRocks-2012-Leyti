...
<button href="http://betatube.net/sign_up" type="button" class=" yt-uix-button yt-uix-button-primary" onclick=";window.location.href=this.getAttribute('href');return false;" role="button"><span class="yt-uix-button-content">Create Account </span></button>								</div>
								<?php } else { ?>
									<div id="guide-builder-promo">
								...
								<div class="guide-section yt-uix-expander  first ">
									...
									<ul>
										<li class="guide-item-container ">
											<a class="guide-item" data-feed-name="Betatube" data-feed-type="user">
											<span class="thumb">
                                        ...
                                        <?php if(!isset($_SESSION['siteusername'])) { ?>
                                            ...
                                            <?php
                                                ...
                                                while($channel = $stmt->fetch(PDO::FETCH_ASSOC)) { $channel = $channel['reciever'];
													$_user22 = $__user_h->fetch_user_username($channel);
													if($_user22['title'])	{
														$cdname = htmlspecialchars($_user22['title']);
													} else{
														$cdname = $channel;
													}
													?>
                                                ...
                                                <li class="guide-item-container ">
                                                    ...
                                                    <span class="display-name">
                                                        <?php echo htmlspecialchars($cdname); ?>
                                                    </span>
                                                    </a>
                                                </li> 
                                            <?php } ?>
									...
									<div class="guide-item-container">
										<span class="guide-item guide-item-action guide-item-fake">
										<a href="/subscriptions">see all<img src="//s.ytimg.com/yt/img/pixel-vfl3z5WfW.gif" class="see-more-arrow" alt=""></a>        </span>
									</div>
								</div>
							</div>
						</div>
						...
						<div id="video-sidebar">
							...
							<h2>Welcome to Betatube!</h2>
							<p class="sidebar-module-description">
								Why not enjoy or upload some videos?
							</p>
							<p class="sidebar-module-description">
								Presented by: <a href="/user/Betatube">Betatube</a>
							</p>
							<ul>
								<?php
									...
									while($video = $stmt->fetch(PDO::FETCH_ASSOC)) {	
										...
										$video['description'] = $__video_h->shorten_description($video['description'], 50);
													...
													if($_user22['title'])	{
														$video['dname'] = htmlspecialchars($_user22['title']);
													} else{
								...
								<li class="video-list-item "><a href="/watch?v=<?php echo $video['rid']; ?>" class="video-list-item-link yt-uix-sessionlink" data-sessionlink="ei=CNLr3rbS3rICFSwSIQodSW397Q%3D%3D&amp;feature=g-sptl%26cid%3Dinp-hs-ytg"><span class="ux-thumb-wrap contains-addto "><span class="video-thumb ux-thumb yt-thumb-default-120 "><span class="yt-thumb-clip"><span class="yt-thumb-clip-inner"><img src="http://s.ytimg.com/yt/img/pixel-vfl3z5WfW.gif" alt="<?php echo $video['title']; ?>" data-thumb="/dynamic/thumbs/<?php echo $video['thumbnail']; ?>" width="120"><span class="vertical-align"></span></span></span></span><span class="video-time"><?php echo $video['duration']; ?></span>
									...
									</span><span dir="ltr" class="title" title="<?php echo $video['title']; ?>"><?php echo $video['title']; ?></span><span class="stat">by <span class="yt-user-name " dir="ltr"><?php echo $video['dname']; ?></span></span><span class="stat view-count">  <span class="viewcount"><?php echo $video['views']; ?> views</span>
									</span></a>
								</li>
								<?php } ?>
							</ul>
											...
											<?php
												...
												while($video = $stmt->fetch(PDO::FETCH_ASSOC)) {	
													...
													if($_user22['title'])	{
														...
														$video['dname'] = htmlspecialchars($video['author']);
													}
