										...
										<div class="context-data-container">
                                                    ...
                                                    ?>
                                                        <div class="context-data-item" data-context-item-id="<?php echo $video['rid'];  ?>" data-context-item-type="video" data-context-item-title="<?php echo $video['title'];  ?>" data-context-item-views="<?php echo $video['views'];  ?> views" data-context-item-user="<?php echo $video['author'];  ?>" data-context-item-time="6:58">
                                                            ...
                                                            <div class="lohp-video-metadata attached">
                                                                ...
                                                                <span class="username-prepend">by</span> <a href="<?php if($_user22['vanity'])	{	?>/<?php echo htmlspecialchars($_user22['vanity']); ?><?php } else{ ?>/user/<?php echo htmlspecialchars($video['author']); ?><?php } ?>" class="yt-uix-sessionlink yt-user-name " data-sessionlink="ei=7pFAUZzAG52shAGGr4DACw" dir="ltr"><?php if($_user22['title'])	{	?><?php echo htmlspecialchars($_user22['title']); ?><?php } else {	?><?php echo htmlspecialchars($video['author']); ?><?php	}	?></a>
                                                                </span>
                                                            </div>
												...
												<div class="lohp-medium-shelves-container">
													...
													<div class="lohp-medium-shelf context-data-item" data-context-item-id="<?php echo $video['rid'];  ?>" data-context-item-type="video" data-context-item-title="<?php echo $video['title'];  ?>" data-context-item-views="5,761,446 views" data-context-item-user="<?php echo $video['author'];  ?>" data-context-item-time="<?php echo $video['duration'];  ?>">
														...
														<div class="lohp-media-object-content lohp-medium-shelf-content">
															...
															<div class="lohp-video-metadata attached">
																<span class="content-uploader">
																<span class="username-prepend">by</span> <a href="<?php if($_user22['vanity'])	{	?>/<?php echo htmlspecialchars($_user22['vanity']); ?><?php } else{ ?>/user/<?php echo htmlspecialchars($video['author']); ?><?php } ?>" class="yt-uix-sessionlink yt-user-name " data-sessionlink="ei=7pFAUZzAG52shAGGr4DACw" dir="ltr">
											...
											<div class="lohp-vbox-list lohp-left-vbox-list">
												...
												<div>
													<div class="lohp-shelf-cell-container lohp-category-shelf last-shelf-in-line">
														<div class="lohp-category-shelf-item-list lohp-shelf-size-3">
															<h2 class="branded-page-module-title">
																<a class="spf-link yt-uix-sessionlink" title="Entertainment" data-sessionlink="ved=CBAQzh4&amp;ei=7pFAUZzAG52shAGGr4DACw">
																Entertainment
																</a>
															</h2>
															<?php
												...
												<div>
													<div class="lohp-shelf-cell-container lohp-category-shelf last-shelf-in-line">
														<div class="lohp-category-shelf-item-list lohp-shelf-size-3">
															<h2 class="branded-page-module-title">
																<a class="spf-link yt-uix-sessionlink" title="Sports" data-sessionlink="ved=CBYQzh4&amp;ei=7pFAUZzAG52shAGGr4DACw">
																Sports
																</a>
															</h2>
															<?php
												...
												<div>
													<div class="lohp-shelf-cell-container lohp-category-shelf ">
														<div class="lohp-category-shelf-item-list lohp-shelf-size-1">
															<h2 class="branded-page-module-title">
																<a class="spf-link yt-uix-sessionlink" href="/user/Betatube?feature=g-logo" title="MaryHDennis3" data-sessionlink="ved=CBwQzh4&amp;ei=7pFAUZzAG52shAGGr4DACw">
																    Official
																</a>
															</h2>
                                                            <?php
													...
													<div class="lohp-shelf-cell-container lohp-category-shelf last-shelf-in-line">
														<div class="lohp-category-shelf-item-list lohp-shelf-size-2">
															<h2 class="branded-page-module-title">
																<a class="spf-link yt-uix-sessionlink" title="Music" data-sessionlink="ved=CB8Qzh4&amp;ei=7pFAUZzAG52shAGGr4DACw">
																Music
																</a>
															</h2>
															<?php
												...
												<div>
													<div class="lohp-shelf-cell-container lohp-category-shelf last-shelf-in-line">
														<div class="lohp-category-shelf-item-list lohp-shelf-size-3">
															<h2 class="branded-page-module-title">
																<a class="spf-link yt-uix-sessionlink" title="Gaming" data-sessionlink="ved=CCQQzh4&amp;ei=7pFAUZzAG52shAGGr4DACw">
																Gaming
																</a>
															</h2>
                                                            <?php
											...
											<div class="lohp-vbox-list lohp-right-vbox-list">
												<div class="lohp-vertical-shelf">
													<h2 class="branded-page-module-title">
														<a class="spf-link yt-uix-sessionlink" title="Gaming" data-sessionlink="ved=CCoQzh4&amp;ei=7pFAUZzAG52shAGGr4DACw">
														Gaming
														</a>
													</h2>
                                                    <?php
													...
													<div class="lohp-vertical-shelf-item context-data-item" data-context-item-id="<?php echo $video['rid'];  ?>" data-context-item-type="video" data-context-item-title="<?php echo $video['title'];  ?>" data-context-item-views="303 views" data-context-item-user="<?php echo $video['author'];  ?>" data-context-item-time="<?php echo $video['duration'];  ?>">
														...
														<div class="lohp-vertical-shelf-item-content lohp-media-object-content">
															...
															<div class="lohp-video-metadata attached">
																<span class="content-uploader">
																<span class="username-prepend">by</span> <a href="/user/<?php echo $video['author'];  ?>" class="yt-uix-sessionlink yt-user-name " data-sessionlink="ei=7pFAUZzAG52shAGGr4DACw" dir="ltr"><?php		if($_user22['partner'] == "y") { ?>
												<?php if($_user22['title'])	{	?>
												<?php echo htmlspecialchars($_user22['title']); ?>
												<?php } else {	?>
												<?php echo htmlspecialchars($_user22['username']); ?>
											...
											<?php	}	?></a>
												...
												<div class="lohp-vertical-shelf">
													<h2 class="branded-page-module-title">
														<a class="spf-link yt-uix-sessionlink" title="Music" data-sessionlink="ved=CC4Qzh4&amp;ei=7pFAUZzAG52shAGGr4DACw">
														Music
														</a>
													</h2>
                                                    <?php
