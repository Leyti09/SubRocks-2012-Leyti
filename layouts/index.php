			...
			<div id="page-container">
				<div id="page" class="  home     branded-page-v2-detached-top  clearfix">
					...
					<div id="content" class="">
						<h1 style="font-size:28px">Layout switcher! (does not apply to channels)</h1>
						<h3>WARNING: There are some bugs with this right now. if you find any, report them.</h3>
						<div style="padding:5px 10px;border:1px solid #cccccc;width:590px;border-radius:5px;overflow:hidden;margin-bottom:15px">
						<img src="2013.png" style="float:left;height:85px;margin-right:15px">
						<div style="float:left;width:450px">
						<strong style="display:block;margin:0 0 5px">Hitchhiker</strong>
						<form action="2013" method="POST"><input class="search_button" type="submit" style="padding:25px 2px;margin: 0 8px 0;" name="switch_1" value="Use this layout!"></form>
						</div>
						<div style="float:right">
						</div>
						<img src="2012.png" style="float:left;height:85px;margin-right:15px">
						<div style="float:left;width:450px">
						<strong style="display:block;margin:0 0 5px">Cosmic Panda</strong>
						<form action="2012" method="POST"><input class="search_button" type="submit" style="padding:25px 2px;margin: 0 8px 0;" name="switch_1" value="Use this layout!"></form>
						</div>
						<div style="float:right">
						</div>
						</div>
