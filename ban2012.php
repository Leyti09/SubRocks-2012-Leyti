...
<?php
	$__server->page_embeds->page_title = "Betatube - u r banned now";
	$__server->page_embeds->page_description = "u r banned";
	$__server->page_embeds->page_url = "https://betatube.net/ban";
?>
<!DOCTYPE html>
<html>
	<head>
			...
			<div id="content-container">
				...
				<div id="content">
                    <div style="width: 410px;margin: auto;">
                        <h1>Banned</h1><br>
                        Our moderators have determined that your behavior at BetaTube <br>has been in
                        violation of our Terms of Service. We have terminated your <br>account. If you make another account, it will also be banned for ban evasion.<br><br>
