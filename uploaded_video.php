...
?>
<?php
	$__server->page_embeds->page_title = "SubRock - Uploaded Video";
		...
		<div id="page" class="">
			...
			<div id="content-container">
				...
				<div id="content">
                    ...
                    <input id="video-link" style="width: 300px;" placeholder="Video Link" class="upload-input" type="text" value="https://www.subrock.tk/watch?v=<?php echo $_video['rid']; ?>" name="title"><br><br>
                    <br>
                </div>
            </div>  
