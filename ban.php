			...
			<div id="page-container">
				<div id="page" class="  home     branded-page-v2-detached-top  clearfix">
					...
					<div id="content" class="">
                        ...
                        <h1>You have been <b>banned</b></h1><br>
                        Our content monitors have determined that your behavior at BetaTube <br>has been in
                        ...
                        <div style="width: 387px;padding: 10px;border: 1px solid #d3d3d3;background: white;border-radius: 7px;">
                            ...
                            <b>Reason:</b> <br><pre style="padding:5px;padding-left:20px;overflow-y:scroll;"><?php echo $ban_info['reason']; ?></pre>
                        </div><br>
						<?php    if($ban_info['reason'] == 'spam') { ?>
						<video height="400" width="600" controls>
								<source src="https://www.betatube.net/dynamic/videos/GqIiaasbEFb.mp4?signature=aintnothinggonnabreakmystrideaintnothinggonnaslowmedownnooigottakeeponmovin" type="video/mp4">
						</video>
						<?php	}	?>
                        <a href="/ban_logout"><button class="yt-uix-button yt-uix-button-default">ok</button></a>
						</div>
					</div>
				</div>
			</div>
